...
var CLASS_LIST = [OBJECT_TYPE.BLANK, OBJECT_TYPE.WALL, OBJECT_TYPE.DOT, OBJECT_TYPE.REI, OBJECT_TYPE.YURI, OBJECT_TYPE.DEX, OBJECT_TYPE.X4, OBJECT_TYPE.PILL, OBJECT_TYPE.GUARDIAN, OBJECT_TYPE.SLUMS]; // prettier-ignore
...
exports.LEVEL = LEVEL;
},{}],"phantomMoves.js":[function(require,module,exports) {
"use strict";
...
function randomMovement(position, direction, objectExist) {
  ...
  while (objectExist(nextMovePos, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _setup.OBJECT_TYPE.PHANTOM)) {
    // Obtain random key from key array
    var key = keys[Math.floor(Math.random() * keys.length)]; // Set next move part 1

    dir = _setup.DIRECTIONS[key]; // Set next move part 2
...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function showGameStatus(gameWin) {
      ...
      div.innerHTML = "".concat(gameWin ? 'YOU WIN GHOSTS:D' : 'YOU LOST TO THE PHANTOMS:(');
    ...
    } // static method - call without instantiating the class
...
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","./setup":"setup.js"}],"Guardian.js":[function(require,module,exports) {
"use strict";
...
var Guardian = /*#__PURE__*/function () {
  function Guardian(speed, startPos) {
  ...
  (0, _createClass2.default)(Guardian, [{
    ...
    value: function getNextMove(objectExist) {
      ...
      if (objectExist(nextMovePos, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _setup.OBJECT_TYPE.SLUMS)) {
    ...
    value: function makeMove() {
      var classesToRemove = [_setup.OBJECT_TYPE.GUARDIAN];
      var classesToAdd = [_setup.OBJECT_TYPE.GUARDIAN];
      return {
    ...
    value: function handleKeyInput(e, objectExist) {
      ...
      if (objectExist(nextMovePos, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _setup.OBJECT_TYPE.SLUMS)) return;
      this.dir = dir;
    }
  }]);
  return Guardian;
...
var _default = Guardian;
exports.default = _default;
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js"}],"Phantom.js":[function(require,module,exports) {
"use strict";
...
var Phantom = /*#__PURE__*/function () {
  function Phantom() {
    ...
    (0, _classCallCheck2.default)(this, Phantom);
    this.name = name;
  ...
  (0, _createClass2.default)(Phantom, [{
    key: "shouldMove",
    value: function shouldMove() {
      if (this.timer === this.speed) {
        this.timer = 0;
    ...
    key: "makeMove",
    value: function makeMove() {
      var classesToRemove = [_setup.OBJECT_TYPE.PHANTOM, _setup.OBJECT_TYPE.SCARED, this.name];
      var classesToAdd = [_setup.OBJECT_TYPE.PHANTOM, this.name];
...
},{}],"sounds/phantom-takeover.mp3":[function(require,module,exports) {
module.exports = "/phantom-takeover.f5610df2.mp3";
},{}],"sounds/death.wav":[function(require,module,exports) {
module.exports = "/death.1b6386ba.wav";
},{}],"sounds/ghost.wav":[function(require,module,exports) {
module.exports = "/ghost.29b4ae25.wav";
},{}],"index.js":[function(require,module,exports) {
"use strict";

var _setup = require("./setup");

var _phantomMoves = require("./phantomMoves");

var _GameBoard = _interopRequireDefault(require("./GameBoard"));

var _Guardian = _interopRequireDefault(require("./Guardian"));
...
var _phantomTakeover = _interopRequireDefault(require("./sounds/phantom-takeover.mp3"));

var _death = _interopRequireDefault(require("./sounds/death.wav"));

var _ghost = _interopRequireDefault(require("./sounds/ghost.wav"));
...
var GLOBAL_SPEED = 80; // milliseconds
...
function gameOver(guardian, grid) {
  ...
  document.removeEventListener('keydown', function (e) {
    return guardian.handleKeyInput(e, gameBoard.objectExist);
  });
...
function checkCollision(guardian, phantoms) {
  var collidedPhantom = phantoms.find(function (phantom) {
    return guardian.pos === phantom.pos;
  });

  if (collidedPhantom) {
    if (guardian.powerPill) {
      playAudio(_ghost.default);
      gameBoard.removeObject(collidedPhantom.pos, [_setup.OBJECT_TYPE.PHANTOM, _setup.OBJECT_TYPE.SCARED, collidedPhantom.name]);
      collidedPhantom.pos = collidedPhantom.startPos;
      score += 420;
    } else {
      gameBoard.removeObject(guardian.pos, [_setup.OBJECT_TYPE.GUARDIAN]);
...
function gameLoop(guardian, phantoms) {
  ...
  phantoms.forEach(function (phantom) {
    return gameBoard.moveCharacter(phantom);
  });
  checkCollision(guardian, phantoms); // Check if guardian eats a dot

  if (gameBoard.objectExist(guardian.pos, _setup.OBJECT_TYPE.DOT)) {
    playAudio(_munch.default);
    gameBoard.removeObject(guardian.pos, [_setup.OBJECT_TYPE.DOT]);
    gameBoard.dotCount--;
    score += 1;
  } // Check if guardian eats a powerpill


  if (gameBoard.objectExist(guardian.pos, _setup.OBJECT_TYPE.PILL)) {
    playAudio(_pill.default);
    gameBoard.removeObject(guardian.pos, [_setup.OBJECT_TYPE.PILL]);
    guardian.powerPill = true;
    score += 69;
    clearTimeout(powerPillTimer);
    powerPillTimer = setTimeout(function () {
      return guardian.powerPill = false;
    }, POWER_PILL_TIME);
  ...
  if (guardian.powerPill !== powerPillActive) {
    ...
    phantoms.forEach(function (phantom) {
      return phantom.isScared = guardian.powerPill;
    });
...
function startGame() {
  playAudio(_phantomTakeover.default);
  gameWin = false;
  powerPillActive = false;
  score = 0;
  startButton.classList.add('hide');
  gameBoard.createGrid(_setup.LEVEL);
  var guardian = new _Guardian.default(2, 287);
  gameBoard.addObject(287, [_setup.OBJECT_TYPE.GUARDIAN]);
  document.addEventListener('keydown', function (e) {
    return guardian.handleKeyInput(e, gameBoard.objectExist);
  });
  var phantoms = [new _Phantom.default(5, 188, _phantomMoves.randomMovement, _setup.OBJECT_TYPE.REI), new _Phantom.default(4, 209, _phantomMoves.randomMovement, _setup.OBJECT_TYPE.YURI), new _Phantom.default(3, 230, _phantomMoves.randomMovement, _setup.OBJECT_TYPE.DEX), new _Phantom.default(2, 251, _phantomMoves.randomMovement, _setup.OBJECT_TYPE.X4)];
  timer = setInterval(function () {
    return gameLoop(guardian, phantoms);
  }, GLOBAL_SPEED);
} // Initialize game


startButton.addEventListener('click', startGame);
},{"./setup":"setup.js","./phantomMoves":"phantomMoves.js","./GameBoard":"GameBoard.js","./Guardian":"Guardian.js","./Phantom":"Phantom.js","./sounds/munch.wav":"sounds/munch.wav","./sounds/pill.wav":"sounds/pill.wav","./sounds/phantom-takeover.mp3":"sounds/phantom-takeover.mp3","./sounds/death.wav":"sounds/death.wav","./sounds/ghost.wav":"sounds/ghost.wav"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/pxnman.e31bb0bc.js.map